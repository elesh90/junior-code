 ...
 * Elf carrying the most Calories. In the example above, this is 24000 (carried by the fourth Elf)
 * Find the Elf carrying the most Calories. How many total Calories is that Elf carrying?
 */

import { caloriesData } from "./puzzle-input";

caloriesData.forEach((caloriesMeal) => {
    let sumCalories = 0;
    if ()
    sumCalories = sumCalories + caloriesMeal;
})